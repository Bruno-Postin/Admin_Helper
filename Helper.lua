...
local script_url = "https://github.com/Bruno-Postin/Admin_Helper/blob/main/Helper.luac?raw=true" -- тут свою ссылку
...
function main()
    ...
    sampAddChatMessage("Admin Helper Versiya 1000", -1)
